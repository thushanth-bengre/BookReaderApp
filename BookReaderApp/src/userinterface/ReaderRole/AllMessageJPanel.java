 ...
 * @author Bengre
 */
public class AllMessageJPanel extends javax.swing.JPanel {

    /**
     * Creates new form AllMessageJPanel
     */
    private JPanel userProcessContainer;
    private Readers account;
    AllMessageJPanel(JPanel userProcessContainer, Readers account) {
        initComponents();
    ...
    private void jButtonReadRespondActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReadRespondActionPerformed
        ...
        if(selectedRowValue >= 0){
            ...
            MessagesJPanel messagesJPanel = new MessagesJPanel(userProcessContainer, account,request,false);
