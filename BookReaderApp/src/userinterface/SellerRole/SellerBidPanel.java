 ...
 * @author Minal
 */
public class SellerBidPanel extends javax.swing.JPanel {
    ...
    SellerBidPanel(JPanel userProcessContainer, Organization organization, UserAccount account, EcoSystem business, Enterprise enterprise) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for(Campaign c: organization.getCd().getListOfCampaign()){
            if(c instanceof BookOfferCampaign){
                Object[] row = new Object[2];
                row[0] = c;
                row[1] = (((BookOfferCampaign) c).getDiscount());
                model.addRow(row);
            }
        }
    }
    ...
    private void btnBidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBidActionPerformed
        ...
        if(selectedRowValue >= 0){
            BookOfferCampaign campaign = (BookOfferCampaign)jTableCamp.getValueAt(selectedRowValue, 0);
            SellerBiddingPanel panel = new SellerBiddingPanel(userProcessContainer,campaign,organization,account,business,enterprise);
